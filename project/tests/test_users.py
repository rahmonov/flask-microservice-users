...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        """ Ensure a new user can be added to a database """
    ...
    def test_single_user(self):
        ...
        user = add_user('michael', 'michael@realpython.com', 'asdasdas11')
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael@realpython.com', 'asdasdasdas', created)
        add_user('fletcher', 'fletcher@realpython.com', 'a13asd13')
        with self.client:
